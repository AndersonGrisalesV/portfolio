        ...
        <div className={styles.container__left__section}>
          ...
          <div className={styles.container__description__text}>
            <p className={styles.description__text}>
              I found the prototyping stage to be particularly enjoyable during
              the design process, as it enabled quick and efficient testing of
              design solutions while refining the user experience. Through
              incorporating user feedback into each iteration of the design, I
              was able to create a mental health management platform that
              prioritizes the needs of the users and their mental health. The
              success of the Healthy Mindset app and website can be attributed
              to the emphasis placed on user experience and the iterative design
              process that allowed for continuous improvement.
            </p>
          </div>
        </div>
