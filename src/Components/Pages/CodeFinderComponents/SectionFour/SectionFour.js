          ...
          <div className={styles.container__right__section}>
            ...
            <div className={styles.container__description__text}>
              <p className={styles.description__text}>
                ...
                paper wireframes for each screen and prioritized taking in mind
                a possible dark theme as well as efficiency, filtering and
                sorting flow. Designs for additional screen sizes were developed
                to ensure the site's full responsiveness. Low-fidelity
